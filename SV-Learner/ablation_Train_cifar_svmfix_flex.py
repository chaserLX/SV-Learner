...
import ablation_dataloader_cifar as dataloader
from math import log2
from Contrastive_loss import *
from ablation_util_svmfix_cifar import svmfix_train_flex
...
parser.add_argument('--sample_threshold', default=0.6, type=float)
...
folder = args.dataset + '_' + args.noise_mode + '_' + str(args.r) + 'SV-Learner + without filter uncorrected samples'
model_save_loc = './checkpoint/' + '/new_ablation_v1/' + folder
